#!/bin/bash -l
#
#SBATCH -J moi_3d_div       #name of your job   
...
#SBATCH --mem=100G          
#SBATCH -o moi_3d_div.%j.o  # the name of the file where the standard output will be written to. %j will be the jobid determined by SLURM
#SBATCH -e moi_3d_div.%j.e  # the name of the file where potential errors will be written to. %j will be the jobid determined by SLURM
...
# 3D
python3 moi_forward_3d_divergence_Atlantic.py --dt=600 20150201
python3 moi_backward_3d_divergence_Atlantic.py  